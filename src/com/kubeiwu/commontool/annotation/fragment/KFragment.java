package com.kubeiwu.commontool.annotation.fragment;
...
/**
 *  需要调用initInjectedView初始化view
 * @author  cgpllx1@qq.com (www.kubeiwu.com)
 * @date    2014-7-22
 */
public class KFragment extends Fragment {
	public static void initInjectedView(Fragment fragment) {
		initInjectedView(fragment, fragment.getView());
	}
