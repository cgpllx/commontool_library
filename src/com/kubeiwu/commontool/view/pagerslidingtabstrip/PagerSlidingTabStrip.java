...
package com.kubeiwu.commontool.view.pagerslidingtabstrip;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		dividerPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_dividerPaddinglibrary, dividerPadding);
		...
		textAllCaps = a.getBoolean(R.styleable.PagerSlidingTabStrip_textAllCapslibrary, textAllCaps);
